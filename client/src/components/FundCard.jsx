...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#2d2d2d] cursor-pointer" onClick={handleClick}>
      <img src={image} alt="fund" className="w-[272px] h-[158px]  rounded-[15px] m-2"/>

      <div className="flex flex-col p-4 m-4 ">
        <div className="flex flex-row items-center mb-[18px]">
          <img src={tagType} alt="tag" className="w-[15px] h-[17px] object-contain "/>
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-white">
            <img src={thirdweb} alt="user" className="w-25 h-25 object-contain"/>
          </div>
